...
public class ShowContact extends BaseActivity {
    ...
    private ContactTB     contactTB = null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setDrawer(true);
        setTitle(R.string.contactDetail);
    ...
    private void setView(long id) {
        ...
        if (contactTB != null) {
            firstView.setText(contactTB.firstName);
            lastView.setText(contactTB.lastName);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case MenuItem_EditID:
                Intent intent = new Intent(this, FormContactDefault.class);
                intent.putExtra("id", contactTB.getId());
